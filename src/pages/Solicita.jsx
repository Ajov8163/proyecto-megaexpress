    ...
    <div>
      ...
      <div className="flex flex-col items-center py-10">
        ...
        <div className="w-full sm:w-3/4 lg:w-2/3 bg-white p-6 rounded-lg shadow-lg relative">
          <button
            onClick={() => navigate("/")}
            className="mb-6 text-[#000735] hover:text-blue-700"
          >
            <FaArrowLeft size={24} />
          </button>
          <h1 className="text-2xl sm:text-4xl font-semibold mb-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <option value="Envio de paquete pesado">
                  Envio de paquete pesado
                </option>
          ...
          <div className="flex justify-center mt-6 gap-4">
            ...
            <button
              onClick={handleClear}
              className="bg-gray-500 text-white px-6 py-2 rounded-lg shadow-lg hover:bg-gray-400 transition duration-300"
            >
              Limpiar
            </button>
          </div>
