...
const Quienessomos = () => {
  return (
    <div className="flex flex-col items-center sm:mx-12  justify-center px-3 sm:px-0 h-auto py-12 sm:py-15">
      <h1 className="h1qs sm:text-5xl font-semibold sm:mb-[4%] mb-[10%]">¿ QUIENES SOMOS ?</h1>
      <div className="contenedor flex w-full justify-between sm:flex-row flex-col gap-8 sm:gap-0 ">
        <div className="border-2 border-gray-400 rounded-3xl p-5 flex items-center flex-col w-full sm:w-[23%] h-auto bg-white">
          <img className="w-[50%] mb-[5%]" src={nosotros} alt="img nosotros" />
        ...
        <div className="border-2 border-gray-400 rounded-3xl p-5 flex items-center flex-col sm:w-[23%] w-full bg-white">
          <img className="w-[50%] mb-[5%]" src={mision} alt="img nosotros" />
        ...
        <div className="border-2 border-gray-400 rounded-3xl p-5 flex items-center flex-col sm:w-[23%] w-full bg-white">
          <img className="w-[50%] mb-[5%]" src={vision} alt="img nosotros" />
        ...
        <div className="border-2 border-gray-400 rounded-3xl p-5 flex items-center flex-col sm:w-[23%] w-full bg-white">
          <img className="w-[50%] mb-[5%]" src={valores} alt="img nosotros" />
