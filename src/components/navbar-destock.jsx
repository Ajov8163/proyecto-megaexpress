...
//         <div className={`sm:block ${isMobileMenuOpen ? "block" : "hidden"}`}>
...
//           )}
//         </div>
//         <div className={`sm:block ${isMobileMenuOpen ? "block bg-orange-400 sm:bg-transparent" : "hidden"} transition-all duration-300 ease-in-out`}>
//           <ol className="flex flex-col w-96 h-90 sm:h-auto sm:w-auto sm:flex-row list-none sm:text-white gap-6  border-t sm:border-none border-white">
//             <Link to={"/Quienessomos"}><li>¿ Quines somos ?</li></Link>
//             <a href="#section8" onClick={handleScrollToSection8}><li>Contáctanos</li></a>
//             <Link to={"/Precios"}><li>Precios</li></Link>
//             <Link to={"/Mapas"}><li>Mapas</li></Link>
...
//           )}
//         </div>
//         <div className={`sm:block fixed top-0 right-0 h-full bg-[#000735] transform ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out`}>
//           <ol className="flex flex-col w-64 h-full list-none text-white gap-6 p-4 border-t border-white">
...
//             <li className="py-2">Catálogo de clientes</li>
//           </ol>
//         </div>
//       </div>
//       <div className="hidden sm:block">
...
//           )}
//         </div>
//         <div className={`fixed top-0 right-0 h-full bg-[#000735] transform ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out sm:hidden`}>
//           <ol className="flex flex-col w-64 h-full list-none text-white gap-6 p-4 border-t border-white">
//             <Link to={"/Quienessomos"}><li className="py-2 border-b border-white">¿ Quines somos ?</li></Link>
//             <a href="#section8" onClick={handleScrollToSection8}><li className="py-2 border-b border-white">Contáctanos</li></a>
//             <Link to={"/Precios"}><li className="py-2 border-b border-white">Precios</li></Link>
...
//           </ol>
//         </div>
//         <div className={`fixed top-0 right-0 h-3/5 bg-[#000735] transform ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out sm:hidden`}>
